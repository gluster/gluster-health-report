...
def callback_check_errors(pline):
    ...
    # captured here
    if pline.log_level == "E" and (pline.msg_id == "106009" or pline.msg_id ==
            "106010" or pline.msg_id == "106011" or pline.msg_id == "106012") :
        num_errors += 1
...
def report_check_version_or_cksum_errors_in_glusterd_log(ctx):
    ...
    if num_errors > 0:
        ctx.warning("version or cksum mismatch detected in Glusterd log file", num_errors=num_errors)
